...
import static project_cas.admin_reg_test.TEMPLATE_PROPERTY;
/**
 *
 * @author Sophix
 */
...
//        jtextField.setBackground(Color.pink);
    ...
    private void initComponents() {
        ...
        jComboBox1.setBackground(new java.awt.Color(70, 59, 143));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lecturer", "Head of Department", "Program Coordinator", "Dean", "Administrator" }));
        ...
        jComboBox2.setBackground(new java.awt.Color(70, 59, 143));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Computer Science", "Electrical Engineering", "Mechanical Engineering", "Basic Science", " " }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
        ...
        try{
            ...
            if(emailcheck == false){
                ...
                if(password.equals(pass2)){
                    ...
                    ps.setString(5, role);
                    ps.setString(6, dept);
                    ps.setString(7, enpass);
                    ps.setBinaryStream(8, FingerPrintData, FingerPrintSize);
...
//                    Reader.startCapture();
            ...
            JOptionPane.showMessageDialog(rootPane, "Problem with Registration");
        }
