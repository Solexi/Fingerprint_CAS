 ...
 * @author Sophix
 */
public class admin_reg_test extends javax.swing.JFrame {
...
//        jtextField.setBackground(Color.pink);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_reg_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_reg_test().setVisible(true);
            }
        });
    }
