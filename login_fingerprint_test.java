 ...
 * @author Sophix
 */
public class login_fingerprint_test extends javax.swing.JFrame {
    ...
    /**
     * Creates new form login_fingerprint
     */
    public login_fingerprint_test() {
        initComponents();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (result.isVerified()) {
                    ...
                    Reader.stopCapture();
                    template = null;
                    Administrator in = new Administrator();
                    in.show();
                    in.setVisible(true);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_fingerprint_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_fingerprint_test().setVisible(true);
            }
        });
    }
